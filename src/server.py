...
if __name__ == "__main__":
  ...
  parser.add_argument('--dataset', dest='dataset', default=None, help='provide a filemask to scoop up training data.')
  args, more = parser.parse_known_args()

  # gather training data in datapath with a prefix of train_*
  train_path = glob.glob("../dataset/camera/train_*")

  # gather validation data in datapath with a prefix of val_*
  validation_path = glob.glob("../dataset/camera/val_*")

  if args.dataset is not None:
    datapath = glob.glob(args.dataset)
